...
import os
servername = 'learning-pytho.com'       # where site is relocating to
...
templaname = 'template.html'            # template for generated pages

try:
    os.mkdir(uploaddir)                 # make upload dir if needed
except OSError: pass

template = open (templaname).read()     # load or import template text
